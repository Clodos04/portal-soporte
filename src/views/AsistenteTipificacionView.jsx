        ...
        {paso === 4 && (
          <div className="space-y-4 animate-fade-in text-center py-2">
            ...
            <div className="flex justify-center gap-3 pt-2">
              <button type="button" onClick={reiniciar} className="bg-slate-800 hover:bg-slate-700 text-slate-300 px-4 py-2 rounded-xl text-xs font-bold border border-slate-700 cursor-pointer">
                Reiniciar
              </button>
